...
import project from "../../data/project_details/way-of-feng-shui.json";

export const WayOfFengShui = () => {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <video autoPlay loop muted playsInline className={styles.demoVid}>
          <source src={`/Project_Details/${project.slug}/${project.slug}.webm`}/>
        </video>
                ...
                {section.sectionAttachment1 !== "" && 
                  <div className={styles.sectionAttachments}>
                    {section.sectionAttachment1.endsWith(".webp") 
                      ? <img src={`/Project_Details/${project.slug}/${section.sectionAttachment1}`}/>
                      : (<video autoPlay muted loop playsInline> <source src={`/Project_Details/${project.slug}/${section.sectionAttachment1}`} /> </video>)
                    }
                    {section.sectionAttachment2 !== ""
                      ? section.sectionAttachment2.endsWith("webp")
                        ? <img src={`/Project_Details/${project.slug}/${section.sectionAttachment2}`}/>
                        : (<video autoPlay muted loop playsInline> <source src={`/Project_Details/${project.slug}/${section.sectionAttachment2}`} /> </video>)
                      : null
                    }
                  </div>
                }
